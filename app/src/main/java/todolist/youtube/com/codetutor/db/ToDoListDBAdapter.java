...
public class ToDoListDBAdapter{
    ...
    public static final String DB_NAME="todolist1213.db";
    ...
    public static String CREATE_TABLE_TODO="CREATE TABLE "+TABLE_TODO+"("+COLUMN_TODO_ID+" INTEGER PRIMARY KEY, "+COLUMN_TODO+" TEXT NOT NULL, "+
            COLUMN_PLACE+ " TEXT, "+COLUMN_PETNAME+" TEXT )";
    ...
    public Cursor getCursorsForAllToDos(){
        Cursor cursor=sqLliteDatabase.query(TABLE_TODO,new String[]{COLUMN_TODO_ID,COLUMN_TODO, COLUMN_PLACE,COLUMN_PETNAME},null,null,null,null,null,null);
        return cursor;
    }

    public Cursor getCursorForSpecificPlace(String place){
        //SELECT task_id,todo FROM table_todo WHERE place LIKE '%desk%'
        Cursor cursor=sqLliteDatabase.query(TABLE_TODO,new String[]{COLUMN_TODO_ID,COLUMN_TODO,COLUMN_PLACE,COLUMN_PETNAME},COLUMN_PLACE +" LIKE '%"+place+"%'",null,null,null,null,null);
        return cursor;
    }
    ...
    public boolean insert(String toDoItem,String place,String petname){
        ContentValues contentValues=new ContentValues();
        contentValues.put(COLUMN_TODO,toDoItem);
    ...
    public List<ToDo> getAllToDos(){
        ...
        if(cursor!=null &cursor.getCount()>0){
            while(cursor.moveToNext()){
                ToDo toDo=new ToDo(cursor.getString(1), cursor.getString(2),cursor.getString(3));
                toDoList.add(toDo);
